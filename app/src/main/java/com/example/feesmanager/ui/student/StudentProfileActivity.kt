...
import com.example.feesmanager.ui.fees.ReceiptActivity
...
import com.example.feesmanager.utils.WhatsAppHelper
        ...
        viewModel.student.observe(this) { result ->
            when (result) {
                ...
                is FmResult.Success -> {
                    ...
                    val currentMonthKey = SimpleDateFormat("yyyy-MM", Locale.getDefault()).format(
                        Date()
                    )
