...
class StudentSettingsFragment : Fragment(R.layout.fragment_student_settings) {

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        view.findViewById<View>(R.id.btnEditProfile).withBounce {
            startActivity(Intent(requireContext(), com.example.feesmanager.ui.profile.StudentEditProfileActivity::class.java))
        }

        view.findViewById<View>(R.id.btnAboutTeacher).withBounce {
            startActivity(Intent(requireContext(), com.example.feesmanager.ui.student.AboutTeacherActivity::class.java))
        }

        view.findViewById<View>(R.id.btnHelp).withBounce {
            startActivity(Intent(requireContext(), StudentFaqActivity::class.java))
        }
