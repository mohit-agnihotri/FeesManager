...
object DrawerHelper {
    ...
    fun setupTeacher(
        ...
        nav(R.id.navProfile)       { activity.startActivity(Intent(activity, SetupProfileActivity::class.java)) }
        nav(R.id.navStudents)      { activity.startActivity(Intent(activity, ViewStudentsActivity::class.java)) }
        nav(R.id.navPayments)      { activity.startActivity(Intent(activity, FeesEntryActivity::class.java)) }
        nav(R.id.navAnalytics)     { activity.startActivity(Intent(activity, AnalyticsActivity::class.java)) }
        nav(R.id.navNotifications) { activity.startActivity(Intent(activity, AnnouncementsActivity::class.java).putExtra("mode","teacher")) }
        nav(R.id.navSettings)      { activity.startActivity(Intent(activity, SettingsActivity::class.java)) }
        nav(R.id.navSupport)       { activity.startActivity(Intent(activity, ClassSelectChatActivity::class.java)) }
        nav(R.id.navAiAssistant)   { activity.startActivity(Intent(activity, TeacherAiActivity::class.java)) }
        nav(R.id.navLogout) {
    ...
    fun setupStudent(
        ...
        nav(R.id.navAcademies)      { activity.startActivity(Intent(activity, MultiAcademyActivity::class.java)) }
        nav(R.id.navPayHistory)     { activity.startActivity(Intent(activity, HistoryActivity::class.java)) }
        nav(R.id.navPendingFees)    { activity.startActivity(Intent(activity, FeeCalendarActivity::class.java)) }
        nav(R.id.navAdvanceBalance) { activity.startActivity(Intent(activity, AdvancePaymentActivity::class.java)) }
        nav(R.id.navNotifications)  { activity.startActivity(Intent(activity, AnnouncementsActivity::class.java).putExtra("mode","student")) }
        nav(R.id.navSettings)       { activity.startActivity(Intent(activity, SettingsActivity::class.java)) }
        ...
        nav(R.id.navAbout) {
            if (teacherId.isNotEmpty() && studentId.isNotEmpty()) {
                activity.startActivity(Intent(activity, MessageActivity::class.java)
