...
import com.example.feesmanager.ui.fees.FeesViewModel
...
class FeesEntryActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        modeSpinner.adapter = ArrayAdapter(this, R.layout.dropdown_item,
        ...
        viewModel.students.observe(this) { result ->
            if (result is FmResult.Success) {
                ...
                actvStudent.setAdapter(ArrayAdapter(this, android.R.layout.simple_dropdown_item_1line, displayNames))
            }
        }
